...
def main():
    ...
    max_replan = int(sys.argv[3]) if len(sys.argv) > 3 else 1
    max_steps = int(sys.argv[4]) if len(sys.argv) > 4 else 40
    time_budget = int(sys.argv[5]) if len(sys.argv) > 5 else None
